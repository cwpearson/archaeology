...
type EditOperation interface {
	fmt.Stringer
	Apply(source, target Levenshteinable, matrix [][]int, i, j int) (int, bool)
...
func (o Match) Apply(source, target Levenshteinable, matrix [][]int, i, j int) (int, bool) {
	if i > 0 && j > 0 && source.Get(i-1).Equals(target.Get(j-1)) {
...
func (o Insertion) Apply(source, target Levenshteinable, matrix [][]int, i, j int) (int, bool) {
	if j > 0 {
...
func (o Deletion) Apply(source, target Levenshteinable, matrix [][]int, i, j int) (int, bool) {
	if i > 0 {
...
func (o Substitution) Apply(source, target Levenshteinable, matrix [][]int, i, j int) (int, bool) {
	if i > 0 && j > 0 {
...
func (o Transposition) Apply(source, target Levenshteinable, matrix [][]int, i, j int) (int, bool) {
	if i > 1 && j > 1 {
		if source == nil && target == nil {
			return matrix[i-2][j-2] + o.Cost, true
		}

		if source.Get(i-1).Equals(target.Get(j-2)) && source.Get(i-2).Equals(target.Get(j-1)) {
			return matrix[i-2][j-2] + o.Cost, true
		}
	}
